...
const HELP_LINES = [
  ...
  "  Enter / Esc (ring)                    open/close k/n/r boxes for the focused track",
  "  t / Shift+T (ring view)               step+TRIG beside ring (Shift+T: playhead, ALL); only *pulse* steps",
  "  ←/→ or [ ] (step+TRIG)                move among pulse steps only (not every bar step)",
  "  Tab                                   TRIG value keys off/on; k=0 has no pulses — step+TRIG is disabled",
  "",
